            ...
            <q-card>
                <q-card-section>
                    <div class="row items-center justify-between q-mb-md">
                        ...
                        <div class="row q-gutter-sm">
                            <q-btn flat color="primary" label="Mark All Read" @click="markAllAsRead"
                                v-if="unreadCount > 0" />
                                ...
                                <q-item-section side>
                                    <div class="row q-gutter-xs">
                                        <q-chip v-if="notification.priority >= 2"
                                            :color="notification.priority === 3 ? 'negative' : 'warning'"
                                ...
                                <q-item-section side>
                                    <div class="row q-gutter-xs">
                                        ...
                                        <q-btn v-if="notification.action" flat round
                                            :icon="notification.action.type === 'navigate' ? 'arrow_forward' : 'info'"
                                            size="sm" @click="handleNotificationAction(notification)" />
                                    </div>
                                </q-item-section>
                            </q-item>
                        </q-list>
                ...
                <q-card-section>
                    <q-form class="q-gutter-md">
                        ...
                        <q-toggle v-model="notificationSettings.savingsEncouragement" label="Savings Encouragement"
                            color="primary" />
                        <q-toggle v-model="notificationSettings.achievementNotifications"
                            label="Achievement Notifications" color="primary" />

                        <q-separator class="q-my-md" />

                        <div class="text-subtitle1 q-mb-sm">Alert Thresholds</div>
                        <q-slider v-model="notificationSettings.reminderDays" :min="1" :max="7" :step="1" label
                            label-always
                        ...
                        <q-slider v-model="notificationSettings.budgetThreshold" :min="50" :max="100" :step="5" label
                            label-always :label-value="`${notificationSettings.budgetThreshold}%`" color="warning" />
                        <div class="text-caption text-center q-mt-sm">
                            Budget percentage to trigger alert
                        </div>

                        <q-slider v-model="notificationSettings.savingsThreshold" :min="25" :max="75" :step="5" label
                            label-always :label-value="`${notificationSettings.savingsThreshold}%`" color="positive" />
                        <div class="text-caption text-center q-mt-sm">
