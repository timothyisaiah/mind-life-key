        ...
        <div class="page-header q-pa-md">
            <div class="row items-center justify-between">
                ...
                <div class="row q-gutter-sm">
                    ...
                    <q-btn color="negative" icon="remove" label="Add Expense"
                ...
                <q-card-section>
                    <div class="row q-gutter-md items-center">
                        <div class="col-12 col-md-3">
                            <q-select v-model="filters.type" :options="typeOptions" label="Type" outlined clearable
                                emit-value map-options />
                        </div>
                        <div class="col-12 col-md-3">
                            <q-select v-model="filters.categoryId" :options="categoryOptions" label="Category" outlined
        ...
        <div class="q-pa-md">
            <q-card>
                <q-card-section>
                    ...
                    <div v-else>
                        <q-list separator>
                            <q-item v-for="transaction in filteredTransactions" :key="transaction.id"
                                class="transaction-item">
                                <q-item-section avatar>
                                    <q-avatar :color="transaction.type === 'income' ? 'positive' : 'negative'"
                                        text-color="white"
            ...
            <q-card style="min-width: 500px">
                ...
                <q-card-section>
                    <q-form @submit="saveTransaction" class="q-gutter-md">
                        ...
                        <q-input v-model.number="transactionForm.amount" label="Amount" type="number" step="0.01"
                            outlined :rules="[val => val > 0 || 'Amount must be greater than 0']" />
                        <q-select v-model="transactionForm.categoryId" :options="categoryOptions" label="Category"
                        ...
                        <q-input v-model="transactionForm.notes" label="Notes (optional)" outlined type="textarea"
                            rows="3" />
                    </q-form>
                </q-card-section>
