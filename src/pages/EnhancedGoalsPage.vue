    ...
    <q-page class="enhanced-goals-page">
        ...
        <div class="page-header q-pa-md">
            <div class="row items-center justify-between">
                ...
                <div class="row q-gutter-sm">
                    ...
                    <q-btn color="secondary" icon="settings" label="Auto-Allocation"
                        @click="showAutoAllocationDialog" />
                    ...
                    <q-card class="goal-card" :class="{ 'completed': goal.currentAmount >= goal.targetAmount }">
                        <q-card-section>
                            <div class="row items-center justify-between q-mb-md">
                                ...
                                <q-chip :color="getGoalStatusColor(goal)" text-color="white"
                            ...
                            <div class="goal-progress q-mb-md">
                                ...
                                <q-linear-progress :value="goal.currentAmount / goal.targetAmount"
                                    :color="getGoalStatusColor(goal)" size="20px" rounded />
        ...
        <q-dialog v-model="showAddMoneyDialogState" persistent>
            <q-card style="min-width: 400px">
                ...
                <q-card-section>
                    <q-form @submit="addMoneyToSelectedGoal" class="q-gutter-md">
            ...
            <q-card style="min-width: 500px">
                ...
                <q-card-section>
                    <q-form class="q-gutter-md">
                        <q-toggle v-model="autoAllocationSettings.enabled" label="Enable Auto-Allocation"
                            color="primary" />
                        <div v-if="autoAllocationSettings.enabled">
                            <q-slider v-model="autoAllocationSettings.percentage" :min="5" :max="50" :step="5" label
                                label-always :label-value="`${autoAllocationSettings.percentage}%`" color="primary" />
                            <div class="text-caption text-center q-mt-sm">
                            ...
                            <div class="q-mt-md">
                                ...
                                <q-list bordered>
                                    <q-item v-for="(goalId, index) in autoAllocationSettings.priorityOrder"
                                        :key="goalId" class="priority-item">
                                        ...
                                        <q-item-section side>
                                            <q-btn flat round icon="close" size="sm"
                                                @click="removeFromPriority(goalId)" />
                                        </q-item-section>
                                    </q-item>
                                </q-list>
