    ...
    <q-page class="cash-flow-forecaster-page">
                ...
                <q-card-section>
                    ...
                    <div class="row q-gutter-md items-center">
                        <div class="col-12 col-md-3">
                            <q-select v-model="forecastSettings.months" :options="monthOptions" label="Forecast Period"
                                outlined emit-value map-options />
                        </div>
                        <div class="col-12 col-md-3">
                            <q-select v-model="forecastSettings.scenario" :options="scenarioOptions" label="Scenario"
                                outlined emit-value map-options @update:model-value="applyScenario" />
                        </div>
                        <div class="col-12 col-md-3">
                            <q-btn color="primary" label="Apply Changes" @click="refreshProjection"
                                class="full-width" />
                        </div>
                        <div class="col-12 col-md-3">
                            <q-btn color="secondary" label="Reset to Default" @click="resetToDefault"
                                class="full-width" />
                        </div>
                    </div>
                </q-card-section>
                        ...
                        <div class="col-12 col-md-6">
                            <q-card flat bordered>
                                <q-card-section>
                                    ...
                                    <q-slider v-model="scenarios.historicalIncomeMultiplier" :min="0.5" :max="2"
                                        :step="0.1" label label-always
                                        :label-value="`${Math.round(scenarios.historicalIncomeMultiplier * 100)}%`"
                        ...
                        <div class="col-12 col-md-6">
                            <q-card flat bordered>
                                <q-card-section>
                                    ...
                                    <q-slider v-model="scenarios.historicalExpensesMultiplier" :min="0.5" :max="2"
                                        :step="0.1" label label-always
                                        :label-value="`${Math.round(scenarios.historicalExpensesMultiplier * 100)}%`"
        ...
        <div class="q-pa-md">
            <q-card>
                <q-card-section>
                    ...
                    <q-table :rows="projection" :columns="projectionColumns" row-key="month"
        ...
        <q-dialog v-model="showSaveDialog" persistent>
            <q-card style="min-width: 400px">
                ...
                <q-card-section>
                    <q-form @submit="saveScenario" class="q-gutter-md">
                        <q-input v-model="scenarioName" label="Scenario Name" outlined
                            :rules="[val => !!val || 'Scenario name is required']" />
                        <q-input v-model="scenarioDescription" label="Description (optional)" outlined type="textarea"
                            rows="3" />
                    </q-form>
                </q-card-section>
