        ...
        <div class="page-header q-pa-md">
            <div class="row items-center justify-between">
                <div>
                    ...
                    <p class="text-subtitle1 text-grey-6 q-ma-none">Comprehensive financial insights and analytics</p>
                </div>
                ...
                <q-card-section>
                    ...
                    <div class="row q-gutter-md items-center">
                        <div class="col-12 col-md-3">
                            <q-select v-model="reportSettings.period" :options="periodOptions" label="Report Period"
                                outlined emit-value map-options @update:model-value="refreshReports" />
                        </div>
                        <div class="col-12 col-md-3">
                            <q-select v-model="reportSettings.year" :options="yearOptions" label="Year" outlined
                                emit-value map-options @update:model-value="refreshReports" />
                        </div>
                        <div class="col-12 col-md-3">
                            <q-select v-model="reportSettings.month" :options="monthOptions" label="Month" outlined
                                emit-value map-options @update:model-value="refreshReports"
                                v-if="reportSettings.period === 'monthly'" />
                        </div>
                        <div class="col-12 col-md-3">
                        ...
                        <q-card-section>
                            <div class="row items-center">
                                <q-icon name="trending_up" size="2rem"
                                    :color="trendAnalysis.income.trend >= 0 ? 'positive' : 'negative'"
                                    class="q-mr-md" />
                                <div class="col">
                        ...
                        <q-card-section>
                            <div class="row items-center">
                                <q-icon name="trending_down" size="2rem"
                                    :color="trendAnalysis.expenses.trend <= 0 ? 'positive' : 'negative'"
                                    class="q-mr-md" />
                                <div class="col">
                        ...
                        <q-card-section>
                            <div class="row items-center">
                                <q-icon name="account_balance" size="2rem"
                                    :color="trendAnalysis.netWorth.trend >= 0 ? 'positive' : 'negative'"
                                    class="q-mr-md" />
                                <div class="col">
                    ...
                    <div class="row q-gutter-md">
                        ...
                        <div class="col-12 col-md-3">
                            <q-card flat bordered>
                                <q-card-section class="text-center">
                                    <q-icon name="account_balance" size="2rem"
                                        :color="yearlyReport.netIncome >= 0 ? 'positive' : 'negative'"
                                        class="q-mb-sm" />
                ...
                <q-card-section>
                    ...
                    <q-table :rows="categoryAnalysis" :columns="categoryColumns" row-key="categoryId"
                        ...
                        <template v-slot:body-cell-categoryName="props">
                            <q-td :props="props">
                                <div class="row items-center">
                                    <div class="category-color-indicator q-mr-sm"
                                        :style="{ backgroundColor: props.row.color }"></div>
                                    {{ props.value }}
                                </div>
                            </q-td>
                        </template>
                        ...
                        <template v-slot:body-cell-percentage="props">
                            <q-td :props="props">
                                <div class="row items-center">
                                    <q-linear-progress :value="props.value / 100" :color="props.row.color" size="8px"
                                        class="q-mr-sm" style="width: 60px" />
